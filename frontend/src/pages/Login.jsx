...
const Login = () => {
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{ width: "100%", maxWidth: { xs: "100%", sm: "420px" }, position: "relative", zIndex: 1 }}>
        <Paper elevation={0} sx={{
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ width: "100%" }}>
            ...
            {/* Custom label + field wrapper — label floating problem fix */}
            {/* EMAIL */}
            <Box sx={{ mb: 2, textAlign: "left" }}>
              <Typography sx={{
                fontSize: 12, fontWeight: "600", color: "#7BBDE8",
                mb: 0.8, letterSpacing: "0.5px", textTransform: "uppercase",
              }}>
                Email Address
              </Typography>
              <Box sx={{
              ...
              <Box sx={{
                ...
                <input
                  ...
                  style={{
                    ...
                    outline: "none",
                     background: "transparent",
   WebkitBoxShadow: "0 0 0 1000px #0f3d5e  inset", // autofill fix
  WebkitTextFillColor: "#E8F4FD",
  caretColor: "#E8F4FD",
                    fontSize: isMobile ? 14 : 15,
                    padding: "14px 0",
